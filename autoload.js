// 0.1.1
try {
    $("<link>").attr({href: "./waifu.css?v=1.4.2", rel: "stylesheet", type: "text/css"}).appendTo('head');
    ...
    $.ajax({url: "./waifu-tips.js?v=1.4.2", dataType:"script", cache: true, success: function() {
        $.ajax({url: "./live2d.min.js?v=1.0.5", dataType:"script", cache: true, success: function() {
                $.ajax({url: "./jquery-ui.min.js", dataType:"script", cache: true, success: function() {
